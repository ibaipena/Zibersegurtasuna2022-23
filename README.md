...
## 3.Lan ildoak:<img align="center" src="img/lerroa.png">
  ...
  - ### 3.2 Pilotuak:
    - **Darktrace:** 
     ...
     Uni Eibar Ikastetxearekin batera, Darktrace izeneko tresna testeatu da aurtengo ikasturtean sareko trafikoaren ikerketa bat egiteko eskeintzen dituen aukerak ebaluatzeko asmoarekin. Bertatik ateratako ondorioak eta pilotu honen balorazio jarraian estekatutako dokumentuan aurkitzen da.[Dokumentazio gida](docs/darktrace/Darktrace Pilotua.pdf)
    - **Smartfense:**
